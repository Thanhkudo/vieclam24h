    ...
    <div class="container-fluid clearfix" style="background-color: #002d40">
        <div class="container">
            ...
            background: radial-gradient(
              ...
              url('{{$image_background}}') repeat center
                center / cover;
            padding: 150px 0;
          ">
                <div class="mx-auto center" style="max-width: 700px">
                    <h2 class="display-2 fw-bold text-white mb-0 ls1 font-secondary mb-4">
                        <i class="icon-heart d-block mb-3"></i>{{$title}}
                    </h2>
                    <a href="{{$url_link}}"
                        class="button button-rounded button-xlarge button-white bg-white button-light text-dark shadow nott ls0 ms-0 mt-5">{{$url_link_title}}</a>
                </div>
            </div>
        </div>
    </div>
