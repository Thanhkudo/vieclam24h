          ...
          <div class="container">
            <div class="header-row justify-content-lg-between">
              ...
              <div id="logo" class="me-lg-5">
                <a
                href="{{ route('frontend.home') }}" data-dark-logo="{{ $web_information->image->logo_header ?? '' }}"
                  class="standard-logo"
                  ><img src="{{ $web_information->image->logo_header ?? '' }}" alt="Header Logo" />
                </a>
                <a
                href="{{ route('frontend.home') }}" data-dark-logo="{{ $web_information->image->logo_header ?? '' }}"
                  class="retina-logo"
              ...
              <nav class="primary-menu with-arrows me-lg-auto">
                <ul class="menu-container align-self-start">
                  <li class="menu-item">
                    <span
                      class="col-auto align-self-start d-flex"
                    ></span>
                  </li>
                  @isset($menu)
                @php
