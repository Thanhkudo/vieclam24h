 ...
 {{-- <script src="{{ asset('themes/frontend/thaiever/js/jquery.calendario.js') }}"></script> --}}
 <script src="{{ asset('themes/frontend/thaiever/demos/nonprofit/js/events.js') }}"></script>
 <script src="{{ asset('themes/frontend/thaiever/js/functions.js') }}"></script>
 <script src="{{ asset('themes/frontend/thaiever/js/components/bs-select.js') }}"></script>
 <script src="{{ asset('themes/frontend/thaiever/js/components/bs-switches.js') }}"></script>
 <script src="{{ asset('themes/frontend/thaiever/js/components/rangeslider.min.js') }}"></script>
